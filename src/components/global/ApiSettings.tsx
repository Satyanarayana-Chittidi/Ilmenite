    ...
    return (
        ...
        >
            <div className='flex items-center justify-between mb-4'>
                ...
                <a className='text-blue-500 hover:text-blue-600 flex items-center gap-1' href="https://github.com/MaanasSehgal/ilmenite?tab=readme-ov-file#how-to-get-api-key" target='_blank'>
                    How to get API key?
                    <ExternalLink size={10} />
                </a>
            </div>
            <motion.div 
                className="bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-black/5 dark:border-white/10 px-3 rounded-2xl shadow-sm"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
